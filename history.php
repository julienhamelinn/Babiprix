				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<p>Devant ce constat, j’ai décidé de créer un index des prix collaboratif pour diffuser les justes prix des biens et services. Je me suis donc autoformé sur le développement web (langages html, CSS, php et sql) et j’ai lancé cet outil numérique collaboratif. Tout le code est en open source et disponible sur mon <a href="https://github.com/julienhamelinn/"> <strong><u>GitHub</u></strong></a>. Le site ne nécessite aucun compte et n’utilise aucun cookie. Tout est conçu pour l’utilisateur et pour la collaboration, sans but lucratif. Il s’agit juste d’un outil que j’aurais aimé avoir en arrivant et dont le développement m’a permis d’acquérir de nouvelles compétences !</p>

							<p>Vous pouvez retrouver d’avantage d’information sur moi sur ma page <a href="https://www.linkedin.com/in/julienhamelin/"><strong><u>LinkedIn</u></strong></a>.</p>

							<p>Bonne navigation et kiff bien ta vie Abidjanaise !!</p>
						</div>
					</div>
